package ua.nure.soprunov.SummaryTask4.web.command;
...
import ua.nure.soprunov.SummaryTask4.web.command.admin.*;
import ua.nure.soprunov.SummaryTask4.web.command.common.*;
import ua.nure.soprunov.SummaryTask4.web.command.dispatcherAndAdmin.ConsiderRequestCommand;
import ua.nure.soprunov.SummaryTask4.web.command.dispatcherAndAdmin.CreateFlightCommand;
import ua.nure.soprunov.SummaryTask4.web.command.dispatcherAndAdmin.DeleteFlightCommand;
import ua.nure.soprunov.SummaryTask4.web.command.dispatcherAndAdmin.EditFlightCommand;
import ua.nure.soprunov.SummaryTask4.web.command.dispatcherAndAdmin.ListAutoFlightsCommand;
import ua.nure.soprunov.SummaryTask4.web.command.driver.*;
